...
<p>Summary:<br/><textarea name="summary" rows="4" cols="80"><?= $sm ?></textarea></p>
...
<input type="hidden" name="profile_id" value="<?= $profile_id ?>">
  ...
  <textarea name=\"desc". $rank ."\" rows=\"4\" cols=\"40\">".$row['description']."</textarea>
</div>";

echo("<script>console.log('Retrive pos: " ."$rank". "');</script>");
                $rank++;
            } 
...
$(document).ready(function(){
    ...
    $('#addPos').click(function(event){
        ...
        $('#position_fields').append(
            ...
            <textarea name="desc'+countPos+'" rows="4" cols="40"></textarea>\
            </div>');
    });
});
</script>	
